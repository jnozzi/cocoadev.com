...
I have two custom General/NSControl subclass.

The first "plan" is a kind of list (big scrollable field) in my main window; wich contains instances of the second General/NSControl subclass "element".
...
I want to save the whole plan data. I thought to use a General/NSMutableArray containing the "plan"'s elements, and a General/NSMutableDictionary to store each "element"'s data. So i would have a General/NSArray storing General/NSDictionary.

My problem is (i'm a newbie hmm hmm.) how can i read the content of the General/TexFields of the Nib inside each "elements"? If i create a General/NSArrayController in the Nib, and then bind it to my fields, how can i read this arrayController from the "element" source?
...
Your questions indicate you should start here: http://developer.apple.com/documentation/Cocoa/Conceptual/General/ObjCTutorial/index.html#//apple_ref/doc/uid/TP40000863

You will also need to read this: http://developer.apple.com/documentation/Cocoa/Conceptual/General/ObjectiveC/index.html#//apple_ref/doc/uid/TP30001163
