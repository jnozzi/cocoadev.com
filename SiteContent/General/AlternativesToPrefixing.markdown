...
Hey ho, <code>MyClass and NetIconaraStupidLibraryMyClass</code> are now two names for the same class. More [[ObjC]] than #defines, but can't undef it though.  --[[TheoHultberg]]
