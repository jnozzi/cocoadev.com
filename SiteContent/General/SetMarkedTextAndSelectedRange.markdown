How should the selectedRange argument of the [[NSTextInput]] selector <code>- (void)setMarkedText:(id)aString selectedRange:([[NSRange]])selRange</code> be interpreted?
