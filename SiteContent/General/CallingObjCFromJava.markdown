...
6. Create a <code>.jobs</code> file. This has become much harder since the [[WrapIt]] tool has disappeared from [[DeveloperTools]] (I don't know when). Here's a sample file. Anything in italics must be replaced by your code.
