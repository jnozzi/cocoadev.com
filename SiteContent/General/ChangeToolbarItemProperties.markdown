Is there way to change the properties (image, label, tooltip etc) of an General/NSToolbarItem during runtime, and have those changes reflected on the toolbar instantly?
