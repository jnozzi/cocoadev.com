...
----
If I were you I'd read up on some of the features of Objective-C 2.0, General/CoreAnimation, and other Leopard-only technologies. The main features of Objective-C 2.0 include properties, garbage collection, and a foreach loop. All of these are enhancements that I would not consider useful enough to prohibit use of your application to Leopard users only. General/CoreAnimation is supposedly a very good feature, although I myself have not played around with it. It is the reason many apps like Delicious Library 2 will be Leopard only. If you plan on General/CoreAnimation being necessary to your app, then you might consider using Leopard only. --General/ACoolie
