...
e.g. 
install_name_tool -id ~/Library/General/MyApp/libMyApp.dylib libMyApp.dylib
...
~some_users_name/Library/General/MyApp/libMyApp.dylib

Although, Might I suggest: ~some_users_name/Library/Application Support/Your Company Name/General/MyApp/libMyApp.dylib
...
Maybe I should change where I install the dylib to. Is it safe to put it somewhere like /usr/local/General/MyApp ?