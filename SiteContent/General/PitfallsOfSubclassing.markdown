...
*Existing code has to be modified to take advantage of your General/SubClass. If that's not what you want, try General/ClassPosing or General/ClassCategories.
*With some classes (notably Apple's classes), you have to be careful to implement a few methods in your General/SubClass. Sometimes it's not so clear which methods these are.
*As above, General/ClassClusters require care.
