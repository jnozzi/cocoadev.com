...
Well, google tells me that     _kCIFormatARGB8 is a General/CoreImage symbol. Are you doing anything with General/CoreImage? Also, have you tried cleaning the target and rebuilding?

----

Yes, I'm using General/CoreImage for its filter.  And yes, I tried cleaning the target and rebuilt but got the same message.  Is this because of General/XCode 2.1?
...
THANK YOU!!! After adding General/QuartzCore.framework, it woks great and actually much faster!!!

Now, another problem I am having is still there.  Without launching from General/MallocDebug, the application cannot process more than one file (please refer to the original 1st question)...  What is causing this???
