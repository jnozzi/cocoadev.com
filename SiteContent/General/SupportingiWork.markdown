...
This precludes us from having to use the "Standard Warning" (about using undocumented [[APIs]] / Specifications). This page can now be re-factored as a how-to / example code page. Yay!
