...
''It's probably easiest to make your main thread merely handle the GUI, and use [[NSObject]]'s <code>-performSelectorOnMainThread:withObject:waitUntilDone:</code> to allow other threads to read/update bindings. Opinions?''
