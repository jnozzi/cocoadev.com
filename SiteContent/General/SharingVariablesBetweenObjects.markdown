...
I have a subclass of General/NSView and a custom General/NSObject. I want that custom object to get access to one of the variables of General/NSView. In other words, I want my custom object to modify an array that is declared in the implementation of my General/NSView.
