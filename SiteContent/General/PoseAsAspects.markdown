...
Would an [[NSInvocation]] help here? You could even wire up a [[HigherOrderMessaging]] trampoline so that <code>[[self performOnSuper] someMethod:arg]</code> would work, probably.
