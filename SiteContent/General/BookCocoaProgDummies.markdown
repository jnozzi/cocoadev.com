...
***Description:**
* Provides all the necessary information for the reader to start writing programs with Cocoa, Apple's newest set of programming General/APIs (Application Program Interfaces) for developing software on and for Mac OS X
...
http://cda.dummies.com/General/WileyCDA/General/DummiesTitle/productCd-0764526138.html
...
OTOH, there a couple of real gems. Like "everything you wanted to know about General/NSCalendarDate but don't quite have a use for yet...."
...
* How about some info about using the MENU!? Why is the "Text" Chapter having you make save buttons, when there is a perfectly good save option in the file menu... If I released an app which used a Button for saving instead of the menu version I'd be the laughing stock of the General/SandBox.
...
* Most of you are being very harsh on this book. This was my first book on COCOA/General/XCode and it got me thru the mechanics of creating simple programs in no time. After I was done with this book I was ready to start exploring on my own. The problem with this book is that it has a For Dummies title and, therefore, there is an implicit prejudice about it. In my opinion this is a very nice book for the person who wants to start programming COCOA/General/XCode. This is a good first book. I give it a BUY IT vote.
