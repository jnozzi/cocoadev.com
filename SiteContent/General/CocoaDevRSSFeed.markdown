...
''Is it possible that there are named HTML entities being introduced? RSS--or at least, feedvalidator--tends to prefer them numbered, like <code>&#039;</code>, instead of named, like <code>&trade;</code>''
