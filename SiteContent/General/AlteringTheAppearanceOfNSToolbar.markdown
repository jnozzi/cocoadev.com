Is it possible to alter the Appearance of the General/NSToolBar? What i would ideally want is to be able to set the appearance of it to be a transparent grey.
