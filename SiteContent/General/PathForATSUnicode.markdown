...
If it's in [[ApplicationServices]].framework, just <code>#import <[[ApplicationServices]]/[[ApplicationServices]].h></code> should be ok. See [http://developer.apple.com/documentation/Carbon/Reference/ATSUI_Reference/]