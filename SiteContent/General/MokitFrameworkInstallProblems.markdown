...
Double click ~/Library/Frameworks/MOKit_embed/General/MOKit.pbproj and open in Xcode. Xcode gives me a warning "The project "General/MOKit.pbproj" was saved with an older version of Xcode. To open it, you must first make a copy of it, which will have the '.xcodeproj' extension. Are you sure you want to open an upgraded copy?"
I click 'upgrade' and save as ~/Library/Frameworks/MOKit_embed/General/MOKit.xcodeproj
...
Compiling General/MoKit/General/MOViewController.m
warning: conflicting types for '-(General/NSView *)view'
...
dyld: Library not loaded: /Library/Frameworks/General/MOKit.framework/Versions/A/General/MOKit
  Referenced from: /Users/benmilford/Documents/COCOA/test2/build/Debug/test2.app/Contents/General/MacOS/test2
...
----
The log is probably correct. You seem to have linked your final executable expecting to find the General/MoKit framework (dynamic library) in     /Library/Frameworks and there is not a copy of it there.

You would find it a bit easier to keep straight if you located the     MOKit_embed source tree in     /Users/benmilford/Documents/COCOA, and copied the built product (    Mokit.framework) to     ~/Library/Frameworks , but this is not at all necessary (and may not be desirable, actually) if you are going to embed the library - like any other source or resource, just place a copy in the source tree of your project, perhaps     /Users/benmilford/Documents/COCOA/test2 , and drag it into the     Frameworks folder of the Project tree/pane in General/XCode.

See General/MoreOnEmbeddingFrameworks for a worked example.