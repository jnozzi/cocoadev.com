...
You can also use <code>ditto -c  --rsrc [--sequesterRsrc] [-k]</code> to archive things. If the -k option is present output will be a zip archive, otherwise it'll be a gzipped cpio archive.
