How do I access the glyph table of fonts? i.e. if I have a string which I want to draw using General/CGContextShowGlyphs then how would I go about transforming the string to glyphs?
