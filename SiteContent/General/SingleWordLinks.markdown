...
More and more often, I've been running into the difficulty of coming up with creative ways to get single words into links (think "General/AnObject", and then thing how we'd go about making a link for Protocols). While I think that the General/WordsJammedTogether route is truly excellent, I, and others as well, I think, would appreciate one of two things:
...
2) as an interim solution (and likely a much easier one), extend the General/WordsJammedTogether thing to not only include NS-prefixed words, but any assortment of capital letters. So, you could do General/AProtocol, or General/AMessage, et cetera. It wouldn't be as perfect as option #1, but it would work for now.
...
*Choose a better pattern match for General/WordsJammedTogether. Perhaps ([A-Z][a-z]*****)+, allowing General/ACategory or General/ObjC or General/KTMatrix but not words with just one capital letter.
...
1 July 2002 - Most of my suggestions are now in General/CocoaDev's engine. I've retired this discussion.
