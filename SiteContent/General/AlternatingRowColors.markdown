If you would like to alternate colors in your General/NSTableView, the same way as with iTunes, use something like this:
...
This posting spellchecked with General/HyperSpell .
