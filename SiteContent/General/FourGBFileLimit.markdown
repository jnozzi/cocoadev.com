If I create a normal document application the system will load files and provide me with an General/NSData which seems to have been initialized with a memory mapped file.
...
I haven't personally had this problem, but you should be able to override General/NSDocument's     -readFromFile:ofType: to just get passed the file's path and do your file reading/writing manually.  Both General/NSFileHandle and the underlying BSD commands support 64-bit file offsets.   -- Bo
...
This is how General/DBMSs works.
...
If you are dealing with data sets this large you probably you probably don't want to be using General/NSData anyway. It will be much faster for you to simply read the portions of the file that you need in large chunks. Instead of waiting for VM pager to do it. 
