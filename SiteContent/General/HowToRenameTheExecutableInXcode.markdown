...
*Change the name of the executable in the Properties pane of the Target inspector (this changes the General/CFBundleExecutable name)
*Change the Product Name in the Build panel of the Target inspector
*Confirm that the the name of the General/CFBundleExecutable key in the Info.plist file reflects this
*Change the General/CFBundleName in the General/InfoPlist.strings file so that the app menu will reflect the new name
