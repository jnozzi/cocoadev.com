When making a program (or framework), you sometimes run into a need to keep your classes visibly separate from all the other classes. Some ways of doing this are to use no prefix (so have, for instance, AppController, SomeKindOfDocument, et cetera as your classes), or to use the My prefix (as described in General/MyApp), or to General/ChooseYourOwnPrefix.

Choosing a prefix is a mix of looking at which frameworks you're including now (e.g. General/FoundationKit or General/AppKit; so you probably never want to prefix your class names with NS), and which frameworks you might conceivably include later. It's all a matter of marking out "namespaces", though it's admittedly not the best way of doing it (Java seems to have done it pretty well, but that's not so helpful to the General/ObjC coders).
...
General/WhenAreNamespacesNecessary?

General/AlternativesToPrefixing. The best alternative seems to be to use a long "formal" class name in the com.whatever style, but to use a #define to shorten it in your code. --General/DustinVoss (and I moved stuff off this page to that)
...
* AA - App Aware
* AB - General/AddressBook framework by Apple (10.2 and later)
* AF - App Factory (The Little App Factory)
* AFX - Audiffex (http://audiffex.com/ )
* AGP - General/AGProductions?
* AI - General/AIUtilities? (Adium)
* AJB - Alf Jørgen Bråtane
* AJ - General/AppJudo? ( http://www.appjudo.com/ )
* AK - AwesomeKit by Pixate (http://pixate.com)
* AL - The MHA ( http://themha.com/ )
* AM - Apple Automator
* AG - General/AagaMatrix? (http://www.agamatrix.com)
* AO - All Out Software
* AP - Acoustic Pond ( http://acousticpond.com )
* AS - appscape http://appscape.at/
* AT - Apptentive http://www.apptentive.com/
* AW - General/AdamWright will make good stuff public soon. Nice General/NSView subclasses and a framework for genetic evolutionary systems.
...
* Ark - Arkonnekt, Sound, General/AudioUnit? API ( http://arksnd.sourceforge.net/ )
* B3S - Busy Being Born Solutions ( http://busy-being-born.com/ )
* BAG - Berufsakademie Glauchau
* BA - General/BackApps service by Krynnlance (http://www.backapps.com/ )
...
* BD - General/BrianDunagan
* BE - Incredible Bee ( https://github.com/incbee )
* BG - Buggy Software
* BL - General/BleuLlama? ( http://umlautllama.com ), but soon to be used in General/LlamaSettings? ( http://code.google.com/p/llamasettings/ )
...
* BW - General/BWToolkit? Framework by Brandon Walkin ( http://brandonwalkin.com/bwtoolkit )
* C - Toxic Software http://toxicsoftware.com/ - I'm greedy. I want a single character prefix too!
* CA - Core Animation (Apple's)
* CB - General/CamelBones ( http://camelbones.sourceforge.net/ )
* CC - General/CodeSpoon? Co. Ltd.
* CE - General/CEUIKit? ( Robert Geifman's CE Code Group, coming march 2007 at http://web.mac.com/robertgeifman )
* CF - General/CoreFoundation (Apple's)
* CG - General/CoreGraphics, aka Quartz (Apple's)
* CH - General/CocoaHeads ( http://cocoaheads.org )
* CI - General/CoreImage, one-half of General/QuartzCore? (Apple's)
* CK - Christian Kienle
...
* CS - General/CoreServices; e.g. General/CSCopyUser?'Name, General/CSCopyMachine?'Name (Apple's)
* CT - General/CoreText?
...
* CV - General/CoreVideo?, one-half of General/QuartzCore? (Apple's)
* CY - General/CubeYellow? Media ( http://www.cubeyellow.com )
* CZ - Carter Allen, General/CZKit?.framework ( http://www.cartera.me/ )
* DB - [http://www.dropbox.com/developers/core/sdk Dropbox SDK], devboys
* DC - General/DiGiCo?, Digital Audio Consoles ( http://www.digiconsoles.com )
* DCT - Daniel Tull ( http://www.danieltull.co.uk )
* DD - Dave General/DeLong? ( http://davedelong.com )
* DDO - dogdaze.org
* DE - devmates
...
* DK - General/DrawKit?, previously General/GCDrawKit.
* DMCS - Data Management & Consultancy Services Inc.
* DMX - intelligent lighting protocol (DMX512) framework and kernel extension, provided by General/MacFOH?.kext - http://www.macfoh.com
* DN - Darknoon - ( http://www.darknoon.com )
* DOG - innodog
* DP - Ofri Wolfus ( http://www.dpompa.com )
* DR - General/DiscRecording (Apple's)
...
* DT - General/DuctTape? (http://culater.net/wiki/moin.cgi/DuctTape)
...
* EC - Sam Deane / Elegant Chaos's General/ECFoundation? Framework ( http://github.com/samdeane/ECFoundation )
...
* FOH - General/MacFOH? app suite, plug-ins, frameworks, daemons, drivers, and kernel classes - http://www.macfoh.com
* FR - fabrizioromeo
* FRB - Fernando Barajas
* FS - General/FScript
* FT - General/FutureTap? ( http://www.futuretap.com/ )
* FU - Fappulous, iPhone/OS X apps. ( http://fappulo.us ).
* Fx - General/FxPlug? (Apple's)
* FZA - Fuzzy Aliens Limited (which means it's likely to be security code: http://fuzzyaliens.com)
* GA - General/GlossyApp?, ( http://www.glossyapp.com )
* GC - General/GrahamCox, including General/GCDrawKit
* GF - General/GroovyFrog? ( http://groovyfrog.com )
...
* GS - General/GnuStep? custom classes (some of those classes might get ported to Cocoa)
* GT - [http://github.com/libgit2/objective-git Objective Git], various projects by General/JonathanGrynspan ("gt" from www.ghosttiger.com, his site)
* HA - Honed Apps
* HB - Hog Bay Software
* HC - Hypnocode General/GmbH? ( http://www.hypnocode.net/ )
* HD - Harpander Ltd
* HF - Harry Flink
* HG - Hans Gerhardt
...
* HX - Hexten
* IA - General/InfoAccent ( http://www.infoaccent.com/ )
* iB - iBench: The Cocoa Benchmark
* IBL - Inspired By Life (http://trigliceridosaltos.info/)
* IC - General/IntelliCore? - http://www.intelli-core.com
* ID - Iterative Development ( http://www.iterative.com )
* IH - General/InterHive? Design and Development - http://www.interhive.net
* IO - General/socializr.io - iOS framework for social network apps
...
* IS - Idea Software
* IS - General/InventiveSoft
* IT - General/IThinkSoftware
* IV - Inteliv Ltd (http://inteliv.com)
* IX - Iconara also Illuminex? -- General/MikeTrent
* J - jer
* JA - General/JohnAllsup?
...
* JR - General/JonathanWolfRentzsch?
* JT - General/JacobBandesStorch -- Also in use by General/JumpTap, Inc ( http://www.jumptap.com/ )
* JV - Javelin.cc Code (used in Colloquy) --General/TimothyHatcher
* General/JvH - Jop van Heesch (General/GameTogether?)
* JZ - Jumpzero ( http://www.jumpzero.com/ )
* KC - General/KirkCode? (http://www.kirkcode.com/)
* KF - General/KenFerry?
* KN - General/KennettNet? Software Ltd ( http://www.kennettnet.co.uk/code/ )
* KPS - Kent Place Software ( http://www.kentplacesoftware.com/ )
* KS - General/KediSoft? ( http://www.kedisoft.com/ )
* L0 - General/EmanueleVulcano aka l0ne (that's a zero, not an O)
* LA - Lord Anubis
...
* LS - General/LaunchServices (Apple's)
* LT - Lauer, Teuber General/GbR? (http://www.app-developers.de)
* M3 - M Cubed Software
...
* MB - General/MattBall's initials. No public objects yet, but some are in the works.
* MC - Marcus Fihlon (General/McPringle?), a Mac and iPhone/iPod software developer ( http://www.mcpringle.ch/ )
* ME - Michael Evan. General/SunSet Software.
* MF - General/MonkeyFood, General/DiggoryLaycock's domain. No public objects as yet - but getting there. :)
...
* MN - General/MobileNotifier? (https://github.com/peterhajas/mobilenotifier)
* MNT - Mintrus (http://mintrus.com)
* MO - Mike Ferris ( http://www.lorax.com/ ) - General/MOKit
* MP - Karl Adam( http://www.matrixPointer.com/ ) - Used in all matrixPointer products and code
* MPW - General/MarcelWeiher ( http://www.metaobject.com/ ) - General/MPWFoundation, General/MPWXmlKit?
* MQ - Maquib Software ( http://www.maquib.com/ )
* MR - Mirek Rusin Ltd ( http://www.accommodationdaylesfordvictoria.com/daylesford/ )
* MSWINDOWS - General/MikeTrent's upcoming operating system. "It'll take the world by storm!" Pre-order yours today.
...
* MU - General/MacUX Project (grmartin.me)
* MV - Used in General/ChatCore (formally derived from Massinvoa) --General/TimothyHatcher
* MVS - Molten Visuals ( http://www.moltenvisuals.com )
* Mc - General/MooreSan's initials, plus it's easier to talk about my McAppController?, McDocument?, McDataSource? etc than MCAppController? etc.
* MW - Monsterworks ( http://www.monsterworks.com/ )
* Mw - General/SmVtSailor
...
* NL - General/NutShell? Framework (http://www.eosgarden.com/ - To be released soon)
* NNS - NińoScript, or "Not General/NeXT Software" - see below.
* NS - General/NeXT Software, now known as Apple (or General/NeXT/Sun.) Not General/NeXTSTEP - see below.
* NT - nepTune Systems (http://neptunesystems.eu)
* NTS - No Thirst Software ( http://nothirst.com )
* NX - Older General/NeXTSTEP prefix (starting with version 3, I believe. Earlier General/NeXTSTEP versions didn't use a prefix.)
* NY - Ninth Yard ( http://ninthyard.com )
* OA - General/OmniAppKit
* OB - General/OmniBase
* OBS - General/ObjectiveSheep?
* OC - General/OCUnit and General/OCMock testing frameworks (http://www.sente.ch/software/ocunit/ and http://www.mulle-kybernetik.com/software/OCMock/ )
* OCS - General/OcianoSoftware - (http://www.ociano.com.br)
* OE - General/OpenEmu? ( http://openemu.sourceforge.net )
* OF - General/OmniFoundation, also General/ObjFW? (even though it's a different framework, it can be used together with Cocoa just fine through the General/ObjFW?-Bridge package)
* OI - General/OmniImage? Framework
...
* ON - General/OmniNetworking
* OS - General/OpenSwordGroup?
* OOT - One Orange Tree ( http://www.oneorangetree.com )
* OR - General/OpenResearch? Software Development OG ( http://www.openresearch.com )
...
* General/PlS? (uppercase-P, lowercase-L, uppercase-S) - General/PlugSuit? classes ( http://infinite-labs.net/plugsuit/ -- some General/PlS?* classes load in all apps on systems where General/PlugSuit? is on.)
* PKM - Patrick Kobler Management (http://www.pk-management.com)
* PL - Plausible Labs ( http://www.plausible.coop )
* PM - General/PeterMaurer
* PP - General/PabloPrietz? 's initials. No public objects yet, but some are in the works.
* PQ - plasq ( http://plasq.com )
* PS - Pinch Software ( http://www.pinchsoftware.com )
* PS - General/PubSub (Apple)
* PSC - Promptu Systems Corporation ( http://www.promptu.com )
* PSY - General/PsychoH?13, Psy| or just Psy, or eventually Remy Demarest ( http://github.com/PsychoH13 )
* PT - General/ProtoThreads ( http://www.frameworklabs.de/protothreads.html )
* PX - Praxxium ( http://praxxium.com )
* PZ - Pepi Zawodsky ( http://taplemon.com, http://twitter.com/TapLemon )
* QS - General/QuickSilver (Open Source Launcher & more) ( http://blacktree.com )
* QV - Quellvetica (http://www.quellvetica.com, http://twitter.com/quellvetica)
* QZ - General/qoerz ( http://www.qoerz.nl )
* RA - R v Amerongen
* RB - General/RainerBrockerhoff
* RC - General/RoundCircle? Enterprise Kit
* RD - Romart Development ( http://romart.ua )
* RE - General/ReNet?.com.au (http://www.renet.com.au)
* RBX - General/RossDude
...
* ROK - General/JepRokApps (http://www.JepRok.com )
* RPC - General/RPCEmu? ( http://www.riscos.info/index.php/RPCEmu )
...
* SAM - General/SimonAndreasMenke
* SC - Functions in Apple's General/SystemConfiguration framework fo detecting network reachability etc.
...
* SCG - General/SwedishCampground?. (Nothing public yet.)
...
* SFC - General/StoneFree? Crowd - http://www.stonefree-crowd.com
* SH - Sheets - Spreadsheet and Analytics Application - recentChaos - recentchaos.com
* SI - Snap Interactive - http://snap-interactive.com
* SKW - high-performance base/app/core/data frameworks by General/ShaunWexler, used in General/MacFOH? suite & plug-ins - http://www.macfoh.com
* SL - Scoreloop - http://www.scoreloop.com
* SL - Stateful Labs - http://stateful.net
* SLP - General/ShermPendley's initials. Nothing published yet (other than General/CamelBones), but I have some stuff in the works. - http://shermpendley.com
* SM - Snooty Monkey - http://www.snootymonkey.com/
* SMC - General/SmartCoon? - http://www.smartcoon.com/
...
* STF - stuffonfire.com - http://www.stuffonfire.com -- Don't you wish people would STFU(tilities)? Found in Newspeak, tickr, General/MFPInterceptor?, commercial stuff...
...
* SW - General/SamWarmuth? Also General/ShockWidgets? -?
* SWM - General/SoftWorks? Media - http://www.softworksmedia.com/
* SX - Stealth Imaging - http://www.stealthimaging.com/ -- H.264 A/V frameworks
* SY - Softyards Software - http://www.softyards.com/
* T2 - Subfuzion, Inc. (founders initials) - iPhone library for social network apps (used by General/TennyEats) - http://www.tennyeats.com
* TC - Thinking Code Software Inc. - http://www.thinkingcode.ca/
* TF - Tanjero frameworks (for apps like General/BitPlayer?)
...
* TM - General/ThinkMac Software
* TM - themacuser - miscellaneous. might pop up in General/KisMac? eventually.
* TMU - themacuser
* TQ - General/TEQneers General/GmbH & Co. KG - http://www.teqneers.com
* TR - Triage Software
...
* TTT - Mattt Thompson
* TW - General/ThoughtWorks
* TX - Toxic Software: http://toxicsoftware.com/
* UA - General/Universal Access (Apple)
* UI - General/UIKit (Apple)
* UK - General/UnitKit - http://www.unitkit.org
* ULI - Uli Kusterer's new prefix for all his open-source stuff to avoid General/UnitKit collision that "UK" now has.
* UN - undefined.org
* UO - General/UnitOOPS? Software http://www.unitoops.com/
* URV - theunraveler.com
* US2 - http://www.ustwo.co.uk
* UT - General/LaunchServices functions for working with General/UniformTypeIdentifiers? (Apple's)
* UW - Used Wheels, objects to get you moving (under construction) http://www.ilike.co.nz/
* UX - n[ui]x Project (Now the General/MacUX Project; grmartin.me)
...
* WO - Wincent, General/WebObjects?
* WS - General/WaveSense? - http://www.wavesense.info
* WT - Watch Tower
...
* ZK - General/ZipKit? http://bitbucket.org/kolpanic/zipkit/
...
I found that Apple stole my initials!! Anybody knows a good lawyer out there? --General/NirSoffer

Isn't LS General/LaunchServices' prefix? --General/EnglaBenny ( My prefix is EB and I don't understand why YOU have to reserve that)

Yep, it is. Luckily, I don't use General/LaunchServices. I'm careful. But it's a good demonstration of where a conflict could potentially occur.

-- General/RobRix (I'd reserve RR, but no, I wouldn't.)

"Luckily, I don't use General/LaunchServices. I'm careful." This doesn't matter. All you have to do is link launch services and you'll have a problem. You don't even have to link it directly. If you link app kit, and app kit links launch services, and you have names that collide, you'll be in trouble. My guess is that app kit does link launch services. Jon H.

----

We only really need to worry about collisions if we're going to be using someone else's code.  There's a pretty good chance I'll use General/MOkit or Omni or the MPW stuff, but for some of the smaller developers (HogBay?), I don't think I'll be using a lot of their stuff.  No reason to contort the prefix you want to use just because someone small beat you to it first.
...
Is there a cocoadev prefix? Then people who want to give ownership of their code to cocoadev could use it. CD is already taken I believe. -- General/MikeAmy

How 'bout CCD as the General/CocoaDev prefix?
...
"Bigram" is used in cryptography and statistical text analysis and is unconnected to sound. --General/AllanBaruz
...
see General/CCDMessageDistributer. -- General/MikeAmy 

----

Is there a real purpose to this page? I highly doubt someone won't use DB because General/DevBoys claimed it (here). Have they ever released anything at all? 
...
The purpose of this page is clear:  it allows us to try to avoid name collisions.  If someone wants to use DB then this page will show them that maybe it isn't a good idea.  It also shows who they should talk to about the prefix.  In your General/DevBoys example, someone who wants to use DB would know of a potential conflict and could ask them if they are actually using it.
...
I just added a bunch of Apple prefixes to the list: General/LaunchServices (LS and UT), General/CoreGraphics (CG), General/CoreServices (CS, with examples), Enterprise Objects Framework (EO), General/CoreImage (CI), General/CoreVideo (CV). --*boredzo*
...
Changed Skorpiostech from ST (which is used by the General/OCUnit stuff) to SKP (SKT was Sketch, thanks boredzo!). 
...
Allowed myself to add my prefix (BTH), since I sometimes publish some General/APIs. -- Tomek Wójcik.
...
Added DB (Dropbox SDK) and GT (Objective Git). I'm not behind either of these projects but use both of them and figured they should be mentioned here. -- General/User:Peterkelly|Peter Kelly