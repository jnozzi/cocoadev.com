I have a partially-transparent custom view, which has several subviews ([[NSButtons]]). The subviews show up with the same transparency as their superview -- is there any way to make the subviews opaque? Thanks.
