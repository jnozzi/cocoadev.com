...
But I�m not sure, in such circumstances, if I should return YES, call [super becomeFirstResponder] ?? and in that case if it must be called before or after doing other operations (like an General/NSLog�)?
