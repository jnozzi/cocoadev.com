[[NSAppleEventDescriptor]] is a wrapper for Carbon's <code>[[AEDesc]]</code> type. Each [[NSAppleEventDescriptor]] has a '''descriptorType''' and '''data'''. The data may contain additional nested <code>[[AEDesc]]</code>s.

An <code>[[AppleEvent]]</code> type is an <code>[[AEDesc]]</code>, as is each parameter of an Apple Script command.
...
*<code>[[AEDesc]]</code> documentation at http://developer.apple.com/documentation/mac/IAC/IAC-98.html
...
<code>[[AEVTBuilder]]</code> is another Cocoa glue classes which build [[NSAppleEventDescriptor]].


----

BEWARE: <code>-descriptorAtIndex:</code> uses a 1-based array!! Does anybody know why this is? Reminds me of the good (not really) ol' BASIC days. --Kevin
...
''I guess the method should have been named <code>-descriptorAtAppleScriptIndex:</code>. [[AppleScript]] uses 1-based array indices, for the same reason BASIC does. -- [[DustinVoss]]''
