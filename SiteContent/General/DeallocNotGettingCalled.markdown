...
I did some research and discovered that Java doesn't (usually) invoke finalizers on application termination either. The documentation for <code>runFinalizersOnExit</code> states:
