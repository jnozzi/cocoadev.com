...
Most of these extensions map to one or more General/UniformTypeIdentifiers, particularly in General/XCode.
...
*.applescript - General/AppleScript source file (com.apple.applescript.text)
*.asdictionary - General/AppleScript dictionary file
...
*.cs - C# Source
*.d - D Source (General/DProgrammingLanguage)
*.el - Emacs Lisp
*.f - Fortran Source
...
*.js - General/JavaScript (not the same thing as Java, com.netscape.javascript-​source)
*.jar - Java General/ARchive (    application/java-archive, com.sun.java-archive)
...
*.mcp - Metrowerks General/CodeWarrior project file
*.ml - ML (e.g. General/OCaml) Source code
...
*.ppob - General/PowerPlant Constructor resource file
...
*.rb - General/REALbasic project files (ew)
...
*.rtfd - "Rich Text Format Directory". RTF text with image or file attachments. A Mac/General/NeXT-specific format. (com.apple.rtfd)
*.tex - See *Source Code*
*.txt - General/TeXT file (    text/plain, public.plain-text)
...
*.eps - Encapsulated General/PostScript (com.adobe.encapsulated-​postscript)
...
*.mov - General/QuickTime (    video/quicktime, com.apple.quicktime-mo<nowiki/>vie)
...
*.ogg - General/OggContainer Multimedia File Format
*.pdf - Portable Document Format (    application/pdf, com.adobe.pdf)
*.pi<nowiki/>ct - General/MacOS General/QuickDraw PICT (    image/pi<nowiki/>ct,     image/x-pi<nowiki/>ct,     image/x-macpict, com.apple.pi<nowiki/>ct)
...
*.ps - General/PostScript (    application/postscript, com.adobe.postscript)
...
*.htm - General/HyperText Markup Language (    text/html, public.html)
*.html - General/HyperText Markup Language (    text/html, public.html)
*.xhtml - eXtensible General/HyperText Markup Language
*.plist - Property List
...
*.kext - Kernel General/EXTension
*.mpkg - see *Archives, Disk Images, Compression*
*.mdimporter - Spotlight Metadata Importer (com.apple.metadata-​importer)
*.nib - General/NeXT Interface Builder
*.pbproj - General/ProjectBuilder project (also openable by General/XCode; see also .xcode)
...
*.xcode - General/XCode project (version 2.0 and earlier)
*.xcodeproj - General/XCode project (version 2.1 and later)


**Archives, Disk Images, Compression**

*.bin - General/MacBinary (    application/x-macbinary,     application/macbinary, com.apple.macbinary-​archive)
*.bz2 - BZip2'd (Compressed)
*.cdr - General/DiskUtility CD/DVD master (disk image)
...
*.hqx - General/BinHex (older textual form for Macintosh two-fork binaries,     application/mac-binhex40,     application/mac-binhex,     application/binhex, com.apple.binhex-archive)
*.iso - ISO CD-ROM disk image
*.mpkg - metapackage installer bundle
*.pkg - Package (Installer bundle)
*.rar - RAR'd file (compressed)
*.sea - Self Extracting Archive
*.sit - General/StuffIt (compressed,     application/x-stuffit,     application/x-sit,     application/stuffit, com.allume.stuffit-archive)
*.sitx - General/StuffIt X (compressed,     application/x-stuffit,     application/x-sit,     application/stuffit, com.allume.stuffit-archive)
*.tar - Tape General/ARchive (    application/x-tar,     application/tar, public.tar-archive)
*.tbz - Tar BZip2'd (Tarred and Compressed)
*.tgz - Tar Gnu Zipped (tarred and compressed, org.gnu.gnu-zip-tar-archive)
*.war - Java Web General/ARchive
*.Z - compressed with Unix Compress
*.zip - Zip compressed (see General/PkWare and General/ZipFileFormat,     application/zip, com.pkware.zip-archive)
...
*.data - Data file
*.dylib - General/DYnamic General/LIBrary
*.in - General/INput file
*.lib - General/LIBrary (object code)
*.log - log file
...
*.org - Original
*.out - General/OUTput file (text or binary)
