[[NSString]] path-oriented methods such as <code>stringByStandardizingPath</code> and <code>lastPathComponent</code> are declared at /System/Library/Frameworks/Foundation.framework/Headers/[[NSPathUtilities]].h. 
