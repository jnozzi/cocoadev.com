...
----
"How to do otherwise" would be to uncheck the "Release when closed" box in IB, or <code>[window setReleasedWhenClosed:NO]</code> in code.
...
You can then type <code>rc ''object''</code> to see an object's retain count.
