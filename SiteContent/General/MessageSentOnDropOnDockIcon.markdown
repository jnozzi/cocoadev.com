...
Look at the General/TextEdit source at /Developer/Examples/General/AppKit/ - it's a non General/NSDocument based app that handles file drag & drop and file packages (RTFD)

Thanks. I appreciate the tip, but I'm no fan of RTF* responses; it's just not nice, particularly when I've spent quite some time reading documentation. --General/ShamylZakariya

I'm not a fan of them either, but in this case RTFD refers to the *file format. ;)* Drag an image into a General/TextEdit document and save it. It will be in RTFD format, which is a file package containing the text portion as rtf, plus the included images in the directory. I only meant to point you to the particular entry in General/TextEdit's doc types listing you should look at.

Arg! My bad. Thanks, again! --General/ShamylZakariya