I have several sub menus with dynamic content, similar to the Recent Items controlled by [[NSDocumentController]].  Each sub menu is controlled by a category (extension).
