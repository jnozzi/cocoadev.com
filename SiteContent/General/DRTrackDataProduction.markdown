Informal protocol that you must implement when you're providing your own data for a General/DRTrack. (See General/DiscRecording for an intro to this topic.) The methods in the protocol are:
