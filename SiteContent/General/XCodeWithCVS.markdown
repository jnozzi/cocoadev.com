...
I initialized the CVS folder with:  '''cvs -d /Users/[[MyUser]]/Development/CVS init'''   and when I did this it created a CVSROOT folder under the CVS folder.  I can only assume that this is working.
