**General/NSResponder** -- General/NSResponder inherits from General/NSObject. Responders have the ability to handle General/NSEvent<nowiki/>s like mouseDown: and keyDown.
