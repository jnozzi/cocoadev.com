I have an General/NSPopupButton in an General/NSToolbar which allows the user to select one of several items. Items can be added, removed and renamed through various means.
