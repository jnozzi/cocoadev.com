I'm a long-time mac user. My programming has been mostly for web or server-side: HTML, javascript, php, perl, General/PostgreSQL. I've also developed a database app for a client in MS Access.
