...
Although its version number series follows on from Apple's previous OS, General/Mac OS (the last version of which was 9.2.2), it actually is more of a descendant of NeXT's last OS, OPENSTEP.
...
Apple has its own IDE for OS X software development, named General/Xcode.
