After reading the General/NSDocumentController, General/NSDocument, General/NSWindowController parts I am not sure if I can use this pattern for a similar design used as for the General/ServerManager. 
