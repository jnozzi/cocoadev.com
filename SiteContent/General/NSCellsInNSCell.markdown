Is there a good tutorial showing how to subclass General/NSCell to create a cell with more than one General/NSCell inside of it?

I need an General/NSCell that displays a multiline block of text at the bottom, with a combobox or popupbutton at the top. Under some circumstances, the popup/combo won't be displayed. The textblock needs to be editable, in a Core Data bindings environment. Cell will be contained in an General/NSOutlineView.
