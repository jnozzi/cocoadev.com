...
----
Yes, your retains and release aren't balanced. For example, you have a bunch of lines like <code>[tempFriend setUid: [tempString retain]]</code> and they will all cause a leak.
