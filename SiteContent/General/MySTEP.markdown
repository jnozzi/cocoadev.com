...
1. How much of the code-base is derived from General/GNUStep? 
...
1. approx. 90%. 
2. completion of Foundation: 95% General/AppKit: 70%. Available: alpha/beta reelases: now.
...
See also: General/DSitRI

----

They have now a more complete description: http://www.dsitri.de/wiki.php?page=General/DigitalCompanion

----

myStep is now General/QuantumStep
