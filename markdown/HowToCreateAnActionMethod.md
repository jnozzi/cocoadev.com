...
The create an action method in Interface Builder you go to the General/MainMenu.nib window and go to the classes tab.  Find the class that you want to add your action method to.  Highlight the class.  Open the info panel (shift-apple-I).  Choose the action tab.  Click the "add" button.  Highlight the newly created action method and rename it whatever you like.
...
*
Because there is a synonymous General/HowToMakeAnActionMethod page, I think this page should be eliminated and have its information merged with what's there. Does that seem like a good idea or is there good reason for the two pages? -- General/BrianMoore
*