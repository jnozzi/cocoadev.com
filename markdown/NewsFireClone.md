*This is an attempt to create a free alternative to General/NewsFire, with similar effects. If you want more info on the various newsreader apps for our platform, see General/RSSNewsReaders. Some of that information was originally posted here, but has been moved to that page.*
...
Does it really use General/NSTableViewRollover?
...
AFAIK General/NewsFire just uses a General/WebView and the CSS :hover pseudo-class.

I'll add some info to General/WebView, since it seems to be kind of lean right now.
...
I'll do it, but see if you can get us somewhere to host the thing. I'm not familiar with how to set up that stuff, or how to do sourceforge. But I do already have quite a bit of stuff, and even a couple icons. -- General/JasonTerhorst
