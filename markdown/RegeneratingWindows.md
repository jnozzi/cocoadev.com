...
Look at     - (BOOL)applicationOpenUntitledFile:(General/NSApplication*)app;  -- Bo

----

I think - (BOOL)applicationShouldOpenUntitledFile:(General/NSApplication *)sender is actually what you want, or does that already return YES by default? (This is a delegate method of General/NSApplication, by the way, so you'll need to override this in your app delegate).

----

Or     - (BOOL)applicationShouldHandleReopen:(General/NSApplication *)theApplication hasVisibleWindows:(BOOL)flag. I beleive this gives you a chance to customize the default behavior, which is probably what iCal does.
