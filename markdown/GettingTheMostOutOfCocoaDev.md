...
First, and most obvious, is to start at the main page (General/CocoaDev), use the jumping-off points, and just browse around.  If you are a linear thinker, this is probably your preferred approach.
...
A third is to go directly to the General/CocoaGlossary and add anything you know about Cocoa which isn't present.

A fourth way is to go directly to the General/RecentChanges page to see if any new material has appeared on the site since the last time you checked. This approach is popular with General/CocoaDev users who frequent the site on a daily basis.

There are other ways you can use this site.

Some General/CocoaDevUsers have kept logs or project diaries on their personal pages, spinning off other informational pages as they go.
...
(see also: General/HowToCreateNewPages, General/HowToUseThisSite)