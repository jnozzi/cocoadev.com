*Editor's Note:* The original Q&A here about how to switch back and forth with full screen using General/OpenGL has been appended to the page General/OpenGLFullScreenToggle.
