Has anyone got example code of using General/RendezVous in their cocoa apps? I know Apple includes picture share but it always crashes and is unstable- i don't want to base my code on that.
