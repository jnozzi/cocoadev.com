...
----
In my experience, accepting mouseMoved: events is nice and fast. I've used it to implement live selection of objects inside complex General/OpenGL views, and it works just fine even on an old 300MHz G3 iBook.