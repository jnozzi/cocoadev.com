The General/NSControl implementation of scrollbars. These are generated and configured automatically by General/NSScrollView. In principle, you shouldn't have much reason to access one directly.
