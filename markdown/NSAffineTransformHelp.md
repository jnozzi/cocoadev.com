...
I'm having som trouble rotating a General/NSBezierPath with General/NSAffineTransform.

    

General/NSRect r = General/SomeRect();
General/NSBezierPath *path = General/[NSBezierPath bezierPath];
General/NSAffineTransform *rot = General/[NSAffineTransform transform];
...
[path lineToPoint:General/NSMakePoint(r.origin.x+r.size.width, r.origin.y)];
[path lineToPoint:General/NSMakePoint(r.origin.x+r.size.width, r.origin.y+r.size.height)];
[path lineToPoint:General/NSMakePoint(r.origin.x, r.origin.y+r.size.height)];
[path closePath];
[path transformUsingAffineTransform:rot];



When I use this code the General/NSBezierPath draw way from where i told it to, where is the problem?
...
General/NSRect r = General/NSMakeRect(0, 0, width, height);
						
General/NSBezierPath *path = General/[NSBezierPath bezierPath];
General/NSAffineTransform *rot = General/[NSAffineTransform transform];
General/NSAffineTransform *pos = General/[NSAffineTransform transform];
General/NSAffineTransform *main = General/[NSAffineTransform transform];
...
[path moveToPoint:General/NSMakePoint(0, 0)];
[path lineToPoint:General/NSMakePoint(r.size.width, 0)];
[path lineToPoint:General/NSMakePoint(r.size.width, r.size.height)];
[path lineToPoint:General/NSMakePoint(0, r.size.height)];
[path closePath];
...
I have a point General/NSPoint(100, 150);
and a size General/NSSize(10, 10) which contains half values

Then i draw bezierpath with the point as center
    
[path moveToPoint:General/NSMakePoint(point.x-size.width, point.y-size.height)];
[path lineToPoint:General/NSMakePoint(point.x+size.width, point.y-size.height)];
[path lineToPoint:General/NSMakePoint(point.x+size.width, point.y+size.height)];
[path lineToPoint:General/NSMakePoint(point.x-size.width, point.y+size.height)];
[path closePath];
