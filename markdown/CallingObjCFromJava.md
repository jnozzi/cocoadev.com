...
6. Create a     .jobs file. This has become much harder since the General/WrapIt tool has disappeared from General/DeveloperTools (I don't know when). Here's a sample file. Anything in italics must be replaced by your code.
...
# Normally General/ObjCJava.jobs is the only one you need, but you
# might also need the General/AppKit (Foundation is included).
# /Developer/Java/Jobs
import General/ObjCJava.jobs
