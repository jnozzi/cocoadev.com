How do i set the background color of a General/NSTextView using Panther's     changeDocumentBackgroundColor method without the text view's text changing color to match?
