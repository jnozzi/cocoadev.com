...
Good stuff. I hope you don't mind but I've added this functionality to General/PDFDocumentCategory and made it a bit more generic in the process. :)
...
If your code is going to be operating on a specific PDF document, then why not make it a member of the General/PDFDocument class?  In Cocoa, this can easily be done through categories.  You would create a category on General/PDFDocument that included your instance method (sans the one and only parameter).  It would then operate on "self", and avoid the entire URL lookup altogether.  Think about it for a second, the programmer will always be able to get a General/PDFDocument for a PDF that he/she wants the dimensions of.  But he/she may not always be able to get a URL (what if my document-based application works on General/PDFDocuments?).
