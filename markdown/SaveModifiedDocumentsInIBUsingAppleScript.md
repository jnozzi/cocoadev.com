...
Sorry for going a little off-topic, but I need an General/AppleScript to save all modified documents in Interface Builder (i.e. like Xcode does before you do a build), but I can't figure out how.
