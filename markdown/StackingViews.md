...
In the containing window controller's     awakeFromNib:
  ...
  [fButton setFrameOrigin:General/NSMakePoint([fButton frame].origin.x, -1)];
  [fButton release];
