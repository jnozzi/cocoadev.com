...
You may be able to find sample code at developer.apple.com . But the idea is to create a subclass of General/NSTextFieldCell and override one of the drawing methods (such as drawWithFrame:inView: or drawInteriorWithFrame:inView:) to get the effect you want. When you get working, could you post your solution here?

-- General/MikeTrent

I thought there already was an option to make text fields round? Which would imply the existence of such in General/NSTextFieldCell... -- General/RobRix

That's not quite the same thing -- General/MikeTrent
...
Oops, I misunderstood what you were asking... sorry, my bad! I'll echo Mike's request for sample code, though, when you've got it. -- General/RobRix
...
Bad news everybody.  drawWithFrame it is.  General/NSBezierPath is it.  A nice clean call it is not.
