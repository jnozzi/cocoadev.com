...
* add a General/NSPrefPaneSearchParameters key to the pane's Info.plist whose content is a String such as "General/MyOwnPrefPane".
...
*English is not my primary language - please proofread, correct & investigate, everyone :D* -- l0ne aka General/EmanueleVulcano

----

I got this working just fine, but does anyone know if General/SearchablePreferencePanes are compatible with Panther? I know some things are just ignored on previous OS's, but I dont have a Panther system to test this on right now.
