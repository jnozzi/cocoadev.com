...
while (General/NSMaxRange(effectiveRange) < General/sourceString string] length]) 
{
...
That sounds like it'd work. You could try     setAttributes:range:, passing nil for the attributes you want to remove. General/NSFontManager has various     convertFont... methods you might find useful as well.
