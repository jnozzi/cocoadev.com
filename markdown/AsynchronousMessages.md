I (General/JonathanGrynspan) put together this code to allow any object to asynchronously perform a method. You use it similarly to how you use -General/[NSUndoManager prepareWithInvocationTarget:]:
